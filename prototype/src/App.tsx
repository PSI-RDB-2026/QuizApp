        ...
        {mode === "home" && (
          <div className="flex flex-col items-center justify-center space-y-8 mt-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 text-center max-w-2xl">
              Challenge yourself in multiple game modes. Conquer the pyramid,
              connect the hexagons, or test your knowledge in the classic mode!
            </p>
...
function GameModeCard({
  ...
  return (
    ...
    >
      <div
        className={`w-20 h-20 rounded-2xl ${color} flex items-center justify-center text-white mb-6 shadow-inner group-hover:scale-110 transition-transform duration-300`}
      >
        <Gamepad2 size={40} />
      </div>
